...
from edsteva.probes.biology.viz_configs.per_measurement.estimates_densities_plot import (
    get_estimates_densities_plot_config,
)
from edsteva.probes.biology.viz_configs.per_measurement.normalized_probe_dashboard import (
    get_normalized_probe_dashboard_config,
)
from edsteva.probes.biology.viz_configs.per_measurement.normalized_probe_plot import (
    get_normalized_probe_plot_config,
)
from edsteva.probes.biology.viz_configs.per_measurement.probe_dashboard import (
    get_probe_dashboard_config,
)
from edsteva.probes.biology.viz_configs.per_measurement.probe_plot import (
...
normalized_probe_dashboard.register(
    "per_measurement_default", func=get_normalized_probe_dashboard_config
)
...
probe_dashboard.register("per_measurement_default", func=get_probe_dashboard_config)
...
estimates_densities_plot.register(
    "per_measurement_default", func=get_estimates_densities_plot_config
)
...
probe_plot.register("per_measurement_default", func=get_probe_plot_config)
