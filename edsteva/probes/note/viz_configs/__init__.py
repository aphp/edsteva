...
from edsteva.probes.note.viz_configs.per_note.estimates_densities_plot import (
    get_estimates_densities_plot_config,
)
from edsteva.probes.note.viz_configs.per_note.normalized_probe_dashboard import (
    get_normalized_probe_dashboard_config,
)
from edsteva.probes.note.viz_configs.per_note.normalized_probe_plot import (
    get_normalized_probe_plot_config,
)
from edsteva.probes.note.viz_configs.per_note.probe_dashboard import (
    get_probe_dashboard_config,
)
from edsteva.probes.note.viz_configs.per_note.probe_plot import get_probe_plot_config
from edsteva.probes.note.viz_configs.per_visit.estimates_densities_plot import (
    get_estimates_densities_plot_config,
)
from edsteva.probes.note.viz_configs.per_visit.normalized_probe_dashboard import (
    get_normalized_probe_dashboard_config,
)
from edsteva.probes.note.viz_configs.per_visit.normalized_probe_plot import (
    get_normalized_probe_plot_config,
)
from edsteva.probes.note.viz_configs.per_visit.probe_dashboard import (
    get_probe_dashboard_config,
)
from edsteva.probes.note.viz_configs.per_visit.probe_plot import get_probe_plot_config
...
normalized_probe_dashboard.register(
    "per_note_default", func=get_normalized_probe_dashboard_config
)
...
probe_dashboard.register("per_note_default", func=get_probe_dashboard_config)
...
estimates_densities_plot.register(
    "per_note_default", func=get_estimates_densities_plot_config
)
...
probe_plot.register("per_note_default", func=get_probe_plot_config)
