...
bio_c = catalogue.create("edsteva.probes.biology", "completeness_predictor")
note_c = catalogue.create("edsteva.probes.note", "completeness_predictor")


class Registry:
    probes = catalogue.create(
        "edsteva",
        "probes",
        entry_points=True,
    )

    models = catalogue.create(
        "edsteva",
        "models",
        entry_points=True,
    )
